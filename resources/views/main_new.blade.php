    ...
    <div class="section">
      ...
      <div class="container home_page">
        <div class="search-holder">
          <h1>iJobs</h1>
          <h2>We invest in human beings</h2>
                    ...
                    <div class="hsb-container">
                      ...
                      <!-- <div class="hsb-select">
                          <div class="uou-custom-select"><select class="form-control">
                            ...
                            <input class="value-holder" type="text" disabled="disabled" placeholder="Select Category">
                            <div class="trigger"><i class="fa fa-caret-down"></i></div><ul class="select-clone"><li data-value="0">Select Category</li><li data-value="">Banking</li><li data-value="">Finance</li><li data-value="">IT</li><li data-value="">Specialists</li></ul></div>
                      </div> -->
                    </div>
                      ...
                      <!-- <div class="row">
                        ...
                        <div class="col-md-9">
                          <div class="uou-custom-select"><select class="form-control">
                            ...
                            <input class="value-holder" type="text" disabled="disabled" placeholder="Select Category">
                            <div class="trigger"><i class="fa fa-caret-down"></i></div><ul class="select-clone"><li data-value="">Select Category</li><li data-value="">Banking</li><li data-value="">Finance</li><li data-value="">IT</li><li data-value="">Specialists</li></ul></div>
                          </div>
                        </div> -->
                      </div>
                  </div>
